...
if [ "$task_no" -eq 1 ]; then
    ...
    echo ${bioemisdir}"US12k_bkvcp_urban2_summer/txt2ntcdf/wrfbiochemi_d01"
    cp ${bioemisdir}"US12k_bkvcp_urban2_summer/txt2ntcdf/wrfbiochemi_d01" ${realdir}"tmpbio.nc"
    ...
    echo ${bioemisdir}"ca4k_bkvcp_urban2_summer/txt2ntcdf/wrfbiochemi_d01"
    cp ${bioemisdir}"ca4k_bkvcp_urban2_summer/txt2ntcdf/wrfbiochemi_d01" ${realdir}"tmpbio.nc"
...
if [ "$task_no" -eq 2 ]; then
    ...
    echo ${bioemisdir}"ca4k_bkvcp_urban2_summer/txt2ntcdf/wrfbiochemi_d01"
    cp ${bioemisdir}"ca4k_bkvcp_urban2_summer/txt2ntcdf/wrfbiochemi_d01" ${ndowndir}"tmpbio.nc"
...
if [ "$task_no" -eq 3 ]; then
    ...
    echo link wrfbio to ${season} file
    echo ${bioemisdir}"ca4k_bkvcp_urban2_summer/txt2ntcdf/wrfbiochemi_d01"
    cp ${bioemisdir}"ca4k_bkvcp_urban2_summer/txt2ntcdf/wrfbiochemi_d01" ${real2dir}"tmpbio.nc"
...
if [ "$task_no" -eq 4 ]; then
    ...
    echo link wrfbio to ${season} file
    echo ${bioemisdir}"ca4k_bkvcp_urban2_summer/txt2ntcdf/wrfbiochemi_d01"
    cp ${bioemisdir}"ca4k_bkvcp_urban2_summer/txt2ntcdf/wrfbiochemi_d01" ${execdir}"tmpbio.nc"
